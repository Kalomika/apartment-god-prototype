...
export function createBattle(aId = 'marine', bId = 'ninja') {
  ...
  return {
    ...
    projectiles: [], effects: [], pickups: [], log: ['Top Shot v0.1 booted. AI fighters only. You coach, drop supplies, or extract.']
  };
}
...
function makeFighter(team, archetype, spawn) {
  return {
    ...
    comboT: 0, actionT: 0, cooldown: 0, rangedCd: 0, meleeCd: 0, specialCd: 0, bandageCd: 0, getupT: 0,
    ...
    memory: { lastSeen: null, lastHitBy: null, fear: 0, mercyRoll: 0.15 + (100 - archetype.stats.aggression) / 300 },
