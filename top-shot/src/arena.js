...
export function createArena() {
  const blocks = [
    r('north_block', 112, 84, 110, 86, null, { cover: true, climbable: true, climbHeight: 1.45, topLabel: 'north container' }),
    r('long_mid_block', 338, 86, 86, 178, null, { cover: true, climbable: true, climbHeight: 1.8, topLabel: 'mid ruin wall' }),
    r('upper_right_block', 612, 112, 164, 136, null, { cover: true, climbable: true, climbHeight: 1.55, topLabel: 'warehouse shell' }),
    r('east_block', 810, 352, 96, 130, null, { cover: true, climbable: true, climbHeight: 1.25, topLabel: 'generator bank' }),
    r('lower_left_block', 86, 514, 118, 122, null, { cover: true, climbable: true, climbHeight: 1.15, topLabel: 'scrap stack' }),
    r('lower_mid_block', 394, 516, 108, 82, null, { cover: true, climbable: true, climbHeight: 1.2, topLabel: 'water tank skid' }),
    r('lower_right_block', 604, 558, 190, 64, null, { cover: true, climbable: true, climbHeight: 1.45, topLabel: 'lower container pair' }),
    r('boulder_north_west', 47, 126, 48, 52, null, { cover: true, boulder: true, climbable: true, climbHeight: 0.7, topLabel: 'boulder' }),
    r('boulder_north_mid', 240, 86, 52, 46, null, { cover: true, boulder: true, climbable: true, climbHeight: 0.55, topLabel: 'boulder' }),
    r('boulder_center', 494, 306, 58, 62, null, { cover: true, boulder: true, climbable: true, climbHeight: 0.55, topLabel: 'boulder' }),
    r('boulder_lower_mid', 276, 628, 58, 48, null, { cover: true, boulder: true, climbable: true, climbHeight: 0.55, topLabel: 'boulder' }),
    r('boulder_east_high', 862, 142, 56, 50, null, { cover: true, boulder: true, climbable: true, climbHeight: 0.65, topLabel: 'boulder' }),
    r('boulder_east_low', 846, 590, 64, 56, null, { cover: true, boulder: true, climbable: true, climbHeight: 0.65, topLabel: 'boulder' })
  ];
  const elevations = [
    r('raised_catwalk_deck', 604, 382, 214, 82, null, { elevation: 1.55, climbable: true, platform: true, topLabel: 'raised catwalk' }),
    r('catwalk_stair_access', 550, 414, 58, 112, null, { elevation: 1.55, climbable: true, stairs: true, access: true, topLabel: 'stairs' })
  ];
  return {
    ...
    breakables: [r('small_crates_a', 450, 310, 54, 38, 35, { cover: true, climbable: true, climbHeight: 0.75, topLabel: 'small crate stack' })],
    weaponSpawns: [],
    debris: []
  };
}
...
function coverPointScore(arena, f, enemy, p) { const travel = Math.hypot(f.x - p.x, f.y - p.y); const exposed = enemy && segmentOpen(arena, p, enemy, 3) ? 140 : 0; const cramped = nearWall(arena, p, 24) ? 20 : 0; return travel + exposed + cramped; }
