...
function fighterStatus(f) {
  ...
  if (f.bleed?.rate > 0) return { label: 'Bleeding', detail: `Blood trail active. Rate ${Number(f.bleed.rate).toFixed(1)}.` };
