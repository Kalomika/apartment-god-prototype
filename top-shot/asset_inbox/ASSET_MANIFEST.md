...
The CQC, stealth, and fighter redesign implementation passes were also committed directly to runtime files on `top-shot-v0-1` because the user explicitly requested implementation, not only handoff notes.
