...
Create the male character realistic top-down sprite production structure, state breakdown, generation prompts, and manifest.
...
- compatible with female and joint-state scale
...
- walk
- run
- sit chair, couch, floor
- sleep solo back, side, curled, awake rest
- get in bed and get out of bed
- phone standing and seated
- laptop desk typing and laptop on lap
- cooking prep, stove, pan stir, mistake react
- eating couch, table, drink
- bathroom safe states, toilet, shower, brush teeth, mirror/groom
- reading standing, couch, bed, pull book
- exercise pushup, yoga/stretch, plank, strength
- pet dog, fetch throw, comfort dog
...
`manifest_male.json` must include every planned state with:
...
- [ ] `MALE_STATE_BREAKDOWN.md` completed
- [ ] `manifest_male.json` valid JSON
