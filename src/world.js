...
export const objects = [
  ...
  { id: 'master_bathtub', label: 'Primary Bathtub', kind: 'bathtub', floor: 1, room: 'master_bath', x: 54, y: 554, w: 116, h: 62, solid: true, enterable: true },
  { id: 'master_shower', label: 'Primary Shower', kind: 'shower', floor: 1, room: 'master_bath', x: 192, y: 548, w: 70, h: 86, solid: true, enterable: true },
  { id: 'master_bath_sink', label: 'Primary Bath Sink', kind: 'sink', floor: 1, room: 'master_bath', x: 292, y: 560, w: 52, h: 40, solid: true },
