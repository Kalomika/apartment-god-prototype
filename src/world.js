...
export const objects = [
  ...
  { id: 'garage_entry_door', label: 'House Door', kind: 'stairs', styleAs: 'door', floor: 3, room: 'garage_entry', x: 628, y: 506, w: 68, h: 34, solid: false, toFloor: 0, exitId: 'garage_door' },
