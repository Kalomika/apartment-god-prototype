...
export const floors = [
  ...
  },
  {
    ...
    name: 'Upstairs',
    rooms: [
      { id: 'bedroom', name: 'Primary Bedroom', x: 24, y: 36, w: 440, h: 300 },
      { id: 'office', name: 'Office', x: 480, y: 36, w: 284, h: 300 },
      { id: 'bath2', name: 'Guest / Hall Bath', x: 780, y: 36, w: 156, h: 300 },
      { id: 'walkin_closet', name: 'Primary Walk In Closet', x: 24, y: 352, w: 174, h: 166 },
      { id: 'master_bath', name: 'Primary Suite Bath', x: 214, y: 352, w: 250, h: 166 },
      { id: 'hall', name: 'Upper Hall', x: 480, y: 352, w: 456, h: 166 },
      { id: 'guest_room', name: 'Guest Bedroom', x: 24, y: 534, w: 430, h: 150 },
      { id: 'upstairs_landing', name: 'Upstairs Landing', x: 470, y: 534, w: 234, h: 150 },
...
export const objects = [
  ...
  { id: 'closet', label: 'Walk In Closet Door', kind: 'closet', floor: 1, room: 'bedroom', x: 72, y: 326, w: 80, h: 26, solid: false, enterable: true, closetEntrance: 'south' },
  ...
  { id: 'master_bathtub', label: 'Primary Bathtub', kind: 'bathtub', floor: 1, room: 'master_bath', x: 228, y: 372, w: 90, h: 56, solid: true, enterable: true },
  { id: 'master_shower', label: 'Primary Shower', kind: 'shower', floor: 1, room: 'master_bath', x: 330, y: 370, w: 58, h: 72, solid: true, enterable: true },
  { id: 'master_bath_sink', label: 'Primary Bath Sink', kind: 'sink', floor: 1, room: 'master_bath', x: 402, y: 374, w: 42, h: 36, solid: true },
  { id: 'master_toilet', label: 'Primary Toilet', kind: 'toilet', floor: 1, room: 'master_bath', x: 400, y: 432, w: 42, h: 52, solid: true, enterable: true },
  { id: 'guest_bed', label: 'Guest Bed', kind: 'bed', floor: 1, room: 'guest_room', x: 54, y: 564, w: 158, h: 82, facing: 'east', headboard: 'west', solid: true, enterable: true },
  { id: 'guest_nightstand', label: 'Guest Nightstand', kind: 'nightstand', floor: 1, room: 'guest_room', x: 224, y: 580, w: 36, h: 36, solid: true },
  { id: 'guest_desk', label: 'Guest Study Desk', kind: 'desk', floor: 1, room: 'guest_room', x: 294, y: 568, w: 112, h: 56, solid: true },
  { id: 'light_bedroom', label: 'Bedroom Light', kind: 'light', floor: 1, room: 'bedroom', x: 402, y: 52, w: 22, h: 22, solid: false },
  { id: 'light_guest_room', label: 'Guest Room Light', kind: 'light', floor: 1, room: 'guest_room', x: 420, y: 550, w: 22, h: 22, solid: false },
