...
export const ACTIONS = {
  ...
  arcade: [['arcade_fighter', 'Play Neon Fighter'], ['arcade_pong', 'Play Orbit Pong'], ['arcade_racer', 'Play Night Racer'], ['arcade_together', 'Two Player Arcade']],
  ...
  basketball_court: [['basketball_1v1', 'Play One on One Basketball']],
...
export const ACTION_TIMES = {
  watch_tv: 60, watch_together: 60, comedy: 60, horror: 60, sports: 60,
  relax: 18, nap: 45, snack: 10, meal: 24, gather_ingredients: 7, cook_meal: 22, serve_meal: 5, bring_food: 12,
  clean: 18, wash_dishes: 18, brush_teeth: 10, groom: 14, shower: 24, pee_stand: 5, toilet: 9,
  sleep: 90, bed_together: 90, make_bed: 10, intimacy: 40, change_clothes: 12, plan_week_outfits: 18,
  get_cleaning_supplies: 8, vacuum_clean: 26, robot_vacuum_start: 4, desk_work: 60, play_game: 45, phone: 18, shop: 24,
  wash_dog: 28, feed_dog: 8, toggle_light: 1, talk: 14, kiss: 5, cuddle: 24, tickle: 7, hands: 12, pet: 10, train: 22, fetch: 0,
  work: 60, errand: 30, mall: 60, movies: 120, date: 90,
  pool_solo: 300, pool_together: 300,
  arcade: 90, arcade_together: 90, arcade_fighter: 90, arcade_pong: 90, arcade_racer: 90,
  console_game: 45, console_together: 50, darts: 24, darts_together: 30,
  throw_trash: 6, take_trash_out: 24, dump_trash: 6,
  treadmill: 35, lift_weights: 35, heavy_bag: 30, swim: 45, swim_together: 50,
  soccer_practice: 45, soccer_match: 60, basketball_1v1: 600, basketball_join: 600,
  dog_rest: 30, call_dog_yard: 8, drive: 18, maintain_vehicle: 35, bike_trip: 36, motorbike_trip: 30,
  music_song: 20, music_album: 60, read: 45, study: 60, coffee: 12, eat_meal: 20, sit_table: 18,
  enter_car: 2, enter_bike: 2, enter_motorbike: 2, enter_atv: 2, pack_luggage: 18, load_luggage: 8, unload_luggage: 8
};
